...
var ReverseProxyAdapter = /** @class */ (function (_super) {
    ...
    function ReverseProxyAdapter(options) {
        ...
        _this._connectUsingSsl = (_a = options.ssl, (_a !== null && _a !== void 0 ? _a : true));
        _this._port = (_b = options.port, (_b !== null && _b !== void 0 ? _b : (_this._connectUsingSsl ? 443 : 80)));
...
export default ReverseProxyAdapter;
