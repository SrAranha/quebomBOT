    ...
    FollowsToUserSubscription.prototype._subscribe = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _b = (_a = this._client._twitchClient.helix.webHooks).subscribeToUserFollowsTo;
                        _c = [this._userId];
    ...
    FollowsToUserSubscription.prototype._unsubscribe = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _b = (_a = this._client._twitchClient.helix.webHooks).unsubscribeFromUserFollowsTo;
                        _c = [this._userId];
                        return [4 /*yield*/, this._getOptions()];
                    case 1: return [2 /*return*/, _b.apply(_a, _c.concat([_d.sent()]))];
                }
...
export default FollowsToUserSubscription;
