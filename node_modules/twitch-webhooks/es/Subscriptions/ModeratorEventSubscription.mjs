            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        _b = (_a = this._client._twitchClient.helix.webHooks).subscribeToModeratorEventsForUser;
                        _c = [this._broadcasterId,
                            this._userId];
                        return [4 /*yield*/, this._getOptions()];
                    case 1: return [2 /*return*/, _b.apply(_a, _c.concat([_g.sent()]))];
                    case 2:
                        _e = (_d = this._client._twitchClient.helix.webHooks).subscribeToModeratorEvents;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        if (!this._userId) return [3 /*break*/, 2];
                        _b = (_a = this._client._twitchClient.helix.webHooks).unsubscribeFromModeratorEventsForUser;
                        _c = [this._broadcasterId,
                            this._userId];
                        return [4 /*yield*/, this._getOptions()];
                    case 1: return [2 /*return*/, _b.apply(_a, _c.concat([_g.sent()]))];
                    case 2:
                        _e = (_d = this._client._twitchClient.helix.webHooks).unsubscribeFromModeratorEvents;
                        _f = [this._broadcasterId];
                        return [4 /*yield*/, this._getOptions()];
                    case 3: return [2 /*return*/, _e.apply(_d, _f.concat([_g.sent()]))];
                }
...
export default ModeratorEventSubscription;
