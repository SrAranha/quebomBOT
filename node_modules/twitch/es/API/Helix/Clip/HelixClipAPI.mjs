...
var HelixClipAPI = /** @class */ (function (_super) {
    ...
    HelixClipAPI.prototype.getClipsForBroadcaster = function (userId, filter) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._getClips(__assign(__assign({}, filter), { filterType: 'broadcaster_id', ids: userId }))];
            });
        });
    };
    /**
    ...
    HelixClipAPI.prototype.getClipsForBroadcasterPaginated = function (userId, filter) {
        if (filter === void 0) { filter = {}; }
        return this._getClipsPaginated(__assign(__assign({}, filter), { filterType: 'broadcaster_id', ids: userId }));
    };
    /**
